...
export interface ILockerSolanaSigner {
...
export async function createLockerSolanaSigner(signer: Keypair | SolanaSigner): Promise<ILockerSolanaSigner> {
    const lockerSolanaSigner: ILockerSolanaSigner = {
        inner: signer,
